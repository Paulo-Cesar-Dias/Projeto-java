...
public class FormClientes extends javax.swing.JInternalFrame {
    ...
    public void listarClientes() { 
        rs = ManterClientes.listarClientes();
        try { 
            if (rs != null && rs.next()) {
            exibirClientes(rs);    
    ...
    public void exibirClientes(ResultSet rs) { 
        try { 
        
        tfIdCliente.setText(new Integer(rs.getInt("id")).toString()); 
    ...
    public void adicionarClientes(){  
        ...
        regInseridos = ManterClientes.adicionarClientes(tfNome.getText(), tfTelefone.getText(), tfEndereco.getText()); 
    ...
    private void atualizarClientes() {
        ...
        regAtualizados = ManterClientes.atualizarClientes(tfIdCliente.getText(),
                tfNome.getText(), tfTelefone.getText(),tfEndereco.getText());
    ...
    private void excluirClientes(){
        ...
        regExcluidos = ManterClientes.excluirClientes(tfIdCliente.getText());
